                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody id="tbody-divisi">
                            <?php foreach($role as $i => $d): ?>
                                <tr id="<?= 'role-' . $d->id_role ?>">
                                    <td><?= ($i+1) ?></td>
                                    <td class="nama-divisi"><?= $d->nama_role ?></td>
                                    <td>
                                        ...
                                        <a href="<?= base_url('role/destroy/' . $d->id_role) ?>" class="btn btn-danger btn-sm btn-delete ml-2" onclick="return false"><i class="fa fa-trash"></i> Hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<div class="modal fade" id="modal-add-divisi" tabindex="-1" role="dialog" aria-labelledby="modal-add-divisi-label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="form-add-divisi" action="<?= base_url('role/store') ?>" method="post" onsubmit="return false">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_role" id="nama-divisi" class="form-control" placeholder="Nama Divisi" required="reuired" />
                    </div>
                </div>
...
<div class="modal fade" id="modal-edit-divisi" tabindex="-1" role="dialog" aria-labelledby="modal-edit-divisi-label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="form-edit-divisi" action="<?= base_url('role/update') ?>" method="post" onsubmit="return false">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="id_role" id="edit-id-divisi">
                        <input type="text" name="nama_role" id="edit-nama-divisi" class="form-control" placeholder="Nama Divisi" required="reuired" />
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
