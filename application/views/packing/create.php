            ...
            <form action="<?= base_url('') ?>" method="post">
                ...
                <div class="card-body border-top py-0 my-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                <label for="nama">Total Weight : </label>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="form-group">
                                <label for="nik">Delivery Qty : </label>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="form-group">
                                <label for="nama">Delivery Weight : </label>
                                <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukana M/C" required="reuqired" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                <label for="nik">Status Packing : </label>
                                <input type="text" name="nik" id="nik" class="form-control" placeholder="Masukan Total" required="reuqired" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                <label for="nik">Status Delivery : </label>
                                <input type="text" name="nik" id="nik" class="form-control" placeholder="Masukan Total" required="reuqired" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                <label for="nik">M/C % : </label>
                                <input type="text" name="nik" id="nik" class="form-control" placeholder="Masukan Total" required="reuqired" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                <label for="nik">M/C Weight : </label>
                                <input type="text" name="nik" id="nik" class="form-control" placeholder="Masukan Total" required="reuqired" />
                            </div>
                        </div>
                    </div>
